	...
	\begin{strip}
		\begin{minipage}{\textwidth}\centering
			\begin{ganttchart}[
				...
				\ganttbar{Preparation \& Setup}{1}{4}\\
				\ganttbar{Quantization}{5}{8}\\
				\ganttbar{Pruning}{9}{12}\\
				\ganttbar{Evaluation \& Edge Device Test}{13}{20}\\
				\ganttbar{Finalizing}{17}{20}\\
				
				% Concurrent task
				\ganttbar[bar/.style={fill=red!30}]{Revising \& Updating}{1}{20}\\
			\end{ganttchart}
		\end{minipage}
	\end{strip}
